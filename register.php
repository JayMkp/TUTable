...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="cap.png">Tshwane University of Technology<br>
      <br>
      <p class="subtitle"> TUTable, the best of the best</p> 
  </div>
</section> 
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; TUTable,the best of the best</p>
     </footer>
 </section>
