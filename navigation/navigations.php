...
<title><?php echo $title;?> | Tshwane University of Technology</title>
...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="images/1234.png"style="width: 17%;object-fit: contain;height: 100%" alt="IMG">
	 <br>
...
<section id="navigation">
  <div id="mySidenav" class="sidenav">
	<a href="<?php echo web_root; ?>index.php?q=home" id="home">Home <i class="fa fa-home pull-right"></i></a> 
    <a href="<?php echo web_root; ?>index.php?q=lesson" id="lesson">Lessons <i class="fa fa-book pull-right"></i></a> 
    <a href="<?php echo web_root; ?>index.php?q=exercises" id="exercise">Exercises <i class="fa fa-pencil pull-right"></i></a>
    <a href="<?php echo web_root; ?>index.php?q=download" id="download">Download <i class="fa fa-archive pull-right"></i></a>
...
<footer  >
    <p align="left">&copy; Tshwane University Of Technology</p>
</footer>
</section>
